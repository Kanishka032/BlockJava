...
const Login = () => {
  ...
  // Handle JWT from OAuth redirect
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F7FF] font-sans p-4 relative overflow-hidden text-[#2D3142]">

      {/* CSS imports and animations */}
      <style>{`
