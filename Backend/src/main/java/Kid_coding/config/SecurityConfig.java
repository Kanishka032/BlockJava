    ...
    http
        ...
        .cors(cors -> cors.configurationSource(request -> {
            ...
            config.setAllowedOrigins(List.of(
                "http://localhost:3000", 
                "http://localhost:5173",
                "https://blockjava-2.onrender.com", // Aapka Frontend
                "https://blockjava-44bpela1j-kanishka032s-projects.vercel.app"
            )); 
            config.setAllowedMethods(List.of("GET","POST","PUT","DELETE","OPTIONS"));
            config.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Requested-With")); // Specific headers are better
        ...
        // 🚨 IMPORTANT: Session management for Cross-Site cookies
